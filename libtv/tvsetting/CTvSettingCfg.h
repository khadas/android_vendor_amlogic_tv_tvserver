...
//HDMI_1_EDID_1.4or2.0
static const int CUSTOMER_DATA_POS_HDMI1_EDID_START         =      (SSM_RW_CUSTOMER_DATA_START + 0);
static const int CUSTOMER_DATA_POS_HDMI1_EDID_SIZE          =      (1);
static const int CUSTOMER_DATA_POS_HDMI1_EDID_END           =      (CUSTOMER_DATA_POS_HDMI1_EDID_START + CUSTOMER_DATA_POS_HDMI1_EDID_SIZE);
//HDMI_2_EDID_1.4or2.0
static const int CUSTOMER_DATA_POS_HDMI2_EDID_START         =      (CUSTOMER_DATA_POS_HDMI1_EDID_END + 0);
static const int CUSTOMER_DATA_POS_HDMI2_EDID_SIZE          =      (1);
static const int CUSTOMER_DATA_POS_HDMI2_EDID_END           =      (CUSTOMER_DATA_POS_HDMI2_EDID_START + CUSTOMER_DATA_POS_HDMI2_EDID_SIZE);
//HDMI_3_EDID_1.4or2.0
static const int CUSTOMER_DATA_POS_HDMI3_EDID_START         =      (CUSTOMER_DATA_POS_HDMI2_EDID_END + 0);
static const int CUSTOMER_DATA_POS_HDMI3_EDID_SIZE          =      (1);
static const int CUSTOMER_DATA_POS_HDMI3_EDID_END           =      (CUSTOMER_DATA_POS_HDMI3_EDID_START + CUSTOMER_DATA_POS_HDMI3_EDID_SIZE);
//HDMI_HDCP_KEY_SWITCHER
static const int CUSTOMER_DATA_POS_HDMI_HDCP_SWITCHER_START =      (CUSTOMER_DATA_POS_HDMI3_EDID_END + 0);
static const int CUSTOMER_DATA_POS_HDMI_HDCP_SWITCHER_SIZE  =      (1);
static const int CUSTOMER_DATA_POS_HDMI_HDCP_SWITCHER_END   =      (CUSTOMER_DATA_POS_HDMI_HDCP_SWITCHER_START + CUSTOMER_DATA_POS_HDMI_HDCP_SWITCHER_SIZE);

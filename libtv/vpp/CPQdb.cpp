    ...
    if (c.moveToFirst()) {
        ...
        if (count == 1) {
            ...
            *dnlpFlag = 1;
            ...
            c.moveToNext();
            newParams->new_dnlp_pst_gmarat = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_sel = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_blk_cctr = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_brgt_ctrl = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_brgt_range = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_brght_add = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_brght_max = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_almst_wht = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_hghbin = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_hghnum = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_lowbin = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_lownum = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_bkgend = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_bkgert = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_blkext = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_whtext = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_bextmx = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_wextmx = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_smhist_ck = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_glb_crate = c.getInt(0);
            c.moveToNext();

            newParams->dnlp_pstgma_brghtrate = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_pstgma_brghtrat1 = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_wext_autorat = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_cliprate_min = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_adpcrat_lbnd = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_adpcrat_hbnd = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_adpmtd_lbnd = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_adpmtd_hbnd = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_set_bext = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_set_wext = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_satur_rat = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_satur_max = c.getInt(0);
            c.moveToNext();
            newParams->blk_prct_rng = c.getInt(0);
            c.moveToNext();
            newParams->blk_prct_max = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_lowrange = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_hghrange = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_auto_rng = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_bin0_absmax = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_bin0_sbtmax = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_adpalpha_lrate = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_adpalpha_hrate = c.getInt(0);
            c.moveToNext();

            newParams->dnlp_lrate00 = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_lrate02 = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_lrate04 = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_lrate06 = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_lrate08 = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_lrate10 = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_lrate12 = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_lrate14 = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_lrate16 = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_lrate18 = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_lrate20 = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_lrate22 = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_lrate24 = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_lrate26 = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_lrate28 = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_lrate30 = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_lrate32 = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_lrate34 = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_lrate36 = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_lrate38 = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_lrate40 = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_lrate42 = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_lrate44 = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_lrate46 = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_lrate48 = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_lrate50 = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_lrate52 = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_lrate54 = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_lrate56 = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_lrate58 = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_lrate60 = c.getInt(0);
            c.moveToNext();
            newParams->dnlp_lrate62 = c.getInt(0);
        }
    }
    return rval;
}

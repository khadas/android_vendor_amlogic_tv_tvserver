...
Return<int32_t> DroidTvServer::tvSetFrontendParms(int32_t feType, int32_t freq, int32_t vStd, int32_t aStd, int32_t p1, int32_t p2) {
    return mTvServiceIntf->tvSetFrontendParms(feType, freq, vStd, aStd, p1, p2);
}
